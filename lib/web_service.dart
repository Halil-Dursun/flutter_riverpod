...
class WebService{
  Future<String> fakeHttpData([String url = 'https://jsonplaceholder.typicode.com']) async{
    await Future.delayed(const Duration(seconds: 2));
    return 'Response from $url';
  }


  Future<IResponseModel<R>> getData<R extends dynamic>([String url = 'https//:jsonplaceholder.com/users']) async{
